...
# Author: Rose Imee Zhella A. Morantte
#
# ARGUMENTS:
...
getVarInfo <- function(fileName, fileFormat, separator = NULL) UseMethod("getVarInfo")

getVarInfo.default <- function(fileName, fileFormat, separator = NULL) {
