ammi.analysis <- function (ENV, GEN, REP, Y, MSE = 0, number = TRUE, graph = "none", yVar = "Y1", ...) {
    ...
    if (graph == "biplot") {
      #png(file = "C:/Documents and Settings/rmorantte/Desktop/pbtools/biplot.png")
#       png(file = paste("C:/Documents and Settings/rmorantte/Desktop/pbtools/biplot_",yVar,"_",gname,".png",sep = ""))
#       png(file = paste(getwd(),"/plots/biplotMea2S_",yVar,".png",sep = ""))
	png(filename = paste(getwd(),"/biplotMea2S_",yVar,".png",sep = ""))
    ...
    if (graph == "triplot") {
        #png(file = "C:/Documents and Settings/rmorantte/Desktop/pbtools/triplot.png")
#       png(file = paste("C:/Documents and Settings/rmorantte/Desktop/pbtools/triplot_",yVar,"_",gname,".png",sep = ""))
    ...
    #ammi1
     filename = paste(getwd(),"/ammi1Mea2S_",yVar,".png",sep = "")
     png(filename = filename)

     par(cex=0.8)
     plot(bplot$Y,bplot$PC1,cex=0.0,text(bplot$Y,bplot$PC1,labels=row.names(bplot),col="blue"),
        main="AMMI1 Biplot",frame=TRUE,xlab="Mean Yield", ylab="PC1")
     MEANS<-mean(bplot$Y)
