...
designSplit.default <- function(main, sub, ssub = NULL, sssub = NULL, r = NULL, trial = 1, design = c('crd', 'rcbd', 'lsd'), 
	...
	if (design == "crd") {  
     ...
     if (design == "rcbd") { randomize <- randomize[,c("trmtLabel", "Trial", "Block",names(main)[[1]], names(sub)[1], "Freq", "newFieldRow", "newFieldCol")] }
	...
	if (!is.null(ssub)) {
		...
		if (design == "rcbd") { randomize <- randomize[,c("trmtLabel", "Trial", "Block",names(main)[[1]], names(sub)[1], names(ssub)[1], "Freq", "newFieldRow", "newFieldCol")] }
	...
	if (!is.null(sssub)) {
		...
		if (design == "rcbd") { randomize <- randomize[,c("trmtLabel", "Trial", "Block",names(main)[[1]], names(sub)[1], names(ssub)[1], names(sssub)[1], "tPNum", "newFieldRow", "newFieldCol")] }
