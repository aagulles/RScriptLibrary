#----------------------------------------------------------------
# This function performs analysis for Diallel III experiments using Griffing Method                          
# (F1's + Reciprocals)                       
#
# ARGUMENTS:
...
# Script Modified by: Nellwyn Sales, Guoyou Ye 
#----------------------------------------------------------------

diallel3Test <-function(design = c("CRD", "RCB", "Alpha", "RowColumn"), data, respvar, p1, p2, rep=NULL, block=NULL, row=NULL, column=NULL, cross=TRUE, individual=NULL, environment=NULL, alpha=0.05) UseMethod("diallel3Test")

diallel3Test.default <-function(design = c("CRD", "RCB", "Alpha", "RowColumn"), data, respvar, p1, p2, rep=NULL, block=NULL, row=NULL, column=NULL, cross=TRUE, individual=NULL, environment=NULL, alpha=0.05) {
